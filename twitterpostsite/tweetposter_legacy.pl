...
sub makeAPICall {
    ...
    $request->header('Authorization' => 'OAuth oauth_consumer_key="UvLInXy98PTQg35Ieur99A5SU",oauth_token="878484823-8xdfwYTTuixVQRDa4XW1IeNupU5aCl66m0qIBHUk",oauth_signature_method="HMAC-SHA1",oauth_timestamp="1659016992",oauth_nonce="MzuK7rvDT3B",oauth_version="1.0",oauth_signature="ygV7ePDV5eNNCA84yVU0mXVwN5E%3D"');
