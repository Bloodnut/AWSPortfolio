...
<!--- boot strap's css dependancy + icon dependancy + mapbox CDN -->
    ...
    <title>Twitter GET site landing page</title>
</head>
<body>
    <!-- ### THIS IS OUR NAV BAR ### -->
    <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 fixed-top">
        <div class="container">
            <a href="#" class="navbar-brand text-info">Anthony's Get Site Landing page</a>
        ...
        <section class="bg-dark text-light p-5 p-lg-2 pt-lg-5 text-center text-sm-start" id="showcase">
            <div class="container">
                <div class="d-sm-flex align-items-center justify-content-between">
                    <div class="px-2">
                        <h1>Anthony's <span class="text-primary"> GET site</span> landing page</h1>
                        <p class="lead my-4">Hit the button below to launch the api get site link thing that 
			pulls a tweet for you!!
                        </p>
                        <form action="tweet_grabber.pl">
                            <button class="btn btn-primary btn-lg my-3"
                            >
                                A button that can pull a tweet! 
                            </button>
                        </form>
                        <form action="https://elgoog.im/%C9%99%E0%B9%85%C9%93oo%E2%85%81">
                            <button class="btn btn-primary btn-lg my-3"
                            >
